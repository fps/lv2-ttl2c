...
struct plugin_callbacks
{
    ...
    void(*run)(struct plugin *instance, uint32_t sample_count, struct plugin_port_gain gain, struct plugin_port_in in, struct plugin_port_out out);
